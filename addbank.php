...
<body>
    ...
    <section class=" bg ">
        ...
        <form action="addbank.php" method="post" class="flex flex-col gap-[19px] h-[70%] md:h-[80%] w-[80%] md:w-[30%] mb-[15px] p-[10px] bg-gray-300/20 items-center justify-center rounded-[20px]">
                ...
                <input type="text" name="logo"  placeholder="Add Logo" value="<?php
                if(isset($_POST["bankid"])){
                    echo $logo;
                }
                ?>" class="outline-none	bg-gray-200 border border-black/50 border-solid md:h-[3rem] h-[2rem] p-[10px] w-[85%] rounded">
                <input type="text" name="bankname"  placeholder="Bank Name" value="<?php
                if(isset($_POST["bankid"])){
                    echo $name;
                }
                ...
                if (isset($_POST['bankid'])) {
                    echo ' 
                                     <input type="submit" name="edited" value="Edit" class="bg-blue-500 hover:bg-blue-700 text-gray-900 font-bold py-2 px-4 w-[85%] rounded cursor-pointer">
                    ';
                } else {
                    echo ' 
                    <input type="submit" name="submit" value="Add Bank" class="bg-blue-500 hover:bg-blue-700 text-gray-900 font-bold py-2 px-4 w-[85%] rounded cursor-pointer">
                    ';
                };
                ?>
            </form>
